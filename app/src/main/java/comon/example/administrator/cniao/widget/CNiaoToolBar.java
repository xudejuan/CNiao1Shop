package comon.example.administrator.cniao.widget;
...
public class CNiaoToolBar extends Toolbar {
    ...
    public CNiaoToolBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(attrs !=null) {
            ...
            @SuppressLint("RestrictedApi") final Drawable rightIcon = a.getDrawable(R.styleable.CNiaoToolBar_rightButtonIcon);
            if (rightIcon != null) {
            ...
            @SuppressLint("RestrictedApi") boolean isShowSearchView = a.getBoolean(R.styleable.CNiaoToolBar_isShowSearchView,false);
